...
X_train2, y_train2 = load_data(cond = "Aug", S = 1, L = 100)
X_train3, y_train3 = load_data(cond = "Aug2", S = 1, L = 100)
X_train4, y_train4 = load_data(cond = "Aug3", S = 1, L = 100)
...
modelCheckpoint = ModelCheckpoint("D:/AugmmentationCode/%s_%s.hdf5" %(case, model_name),save_best_only = True)
...
# load weights
model.load_weights("D:/AugmmentationCode/%s_%s.hdf5" %(case, model_name))
